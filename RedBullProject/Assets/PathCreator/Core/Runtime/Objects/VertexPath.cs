...
namespace PathCreation {
    ...
    public class VertexPath {
        ...
        public Vector4 NewGetPointAtDistance (float dst, EndOfPathInstruction endOfPathInstruction = EndOfPathInstruction.Loop) {
            float t = dst / length;
            Vector4 data = new Vector4(GetPointAtTime(t, endOfPathInstruction).x,
                GetPointAtTime(t, endOfPathInstruction).y, GetPointAtTime(t, endOfPathInstruction).z, length);
            return data;
        }
